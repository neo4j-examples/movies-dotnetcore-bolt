...
* Neo4j Database Connector: https://github.com/neo4j/neo4j-dotnet-driver/[Neo4j .NET Driver] for working with Cypher https://neo4j.com/docs/getting-started/current/languages-guides/neo4j-dotnet/[Driver docs] https://neo4j.com/docs/getting-started/current/cypher-intro/[Cypher Docs]
