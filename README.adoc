...
* Web framework:            https://docs.microsoft.com/fr-fr/aspnet/core/?view=aspnetcore-5.0[ASP.NET core]
...
This uses the ASP.NET core framework, along with the official Neo4j Go driver.
